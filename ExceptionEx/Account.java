...
public class Account {
	 ...
	 private String accountHolderName;
	    ...
	    public double withdraw(double amt) throws InsufficientBalException, ZeroBalException 
	    {
	        if(amt <= this.balance )
	        {
	            this.balance = this.balance - amt;
	        ...
	        else if(amt >= this.balance && this.balance != 0.0)
	        {
	           ...
	           throw new InsufficientBalException(this.balance,amt,this.acctNo);
	        }
	        else {
	        	
	        	throw new ZeroBalException(this.balance, amt,this.acctNo);
	        }
